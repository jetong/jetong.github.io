...
// These are treated as false in conditional operators: 0, NaN, '', null, undefined(no value has been assigned yet)
...
new Map() and new Set() data structures.
...
// to make shallow copy of objects
// say we want to make a shallow copy of obj1.  we assign all the key-value pairs of obj1 to a new empty object
  ...
  render () { // invoked when setState is called
    return ( 
      <div>Count: { this.state.count } 
        < button type = "button" onClick = { this.incrementCount.bind(this) } > Click Me! </button> 
      </div>
    );
  } 
}; 
...
app.use('/handleForm', (req, res) => {
	...
	// Use this JS trick to force animals to start as an empty array, and concat any number of items to it.
